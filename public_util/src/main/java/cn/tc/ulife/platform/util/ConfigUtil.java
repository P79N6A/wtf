...
public class ConfigUtil {
	...
	private static Resource msgsource = new ClassPathResource(
			"/conf/msg.properties");
	...
	public static String getMsgProperties(String key) {
		if (null == msgProps) {
			try {

				msgProps = PropertiesLoaderUtils.loadProperties(msgsource);
