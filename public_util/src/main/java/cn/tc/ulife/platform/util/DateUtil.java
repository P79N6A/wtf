...
public class DateUtil {
	 ...
	 * @see [类、类#方法、类#成员]
	 */
	public static String getDateFromater(String logtime) {
		SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");

		Calendar calendar = Calendar.getInstance();
		calendar.setTimeInMillis(Long.valueOf(logtime));
	 ...
	 * @see [类、类#方法、类#成员]
	 */
	public static String getLongMaxTime(String str) {
		if (null != str && !"".equalsIgnoreCase(str)) {
			long t = Long.valueOf(str);

			long ms = Long.MAX_VALUE - t;
			return getDateFromater(ms + "");
		}
		return null;
	}

	public static long getRowTime(long time) {
		if (time > 0) {
	...
	public static void main(String[] args) {
		// System.out.println(getDateFromater("1426055093810"));
		System.out.println("2015-04-20 00:00:00".substring(0, 13));

		try {
			System.out.println(getDateFormat("yyyy-MM-dd HH:mm:ss").parse(
					"2015-04-20 00:00:00").getTime());
			System.out.println(getDateFormat("yyyy-MM-dd HH:mm:ss").parse(
					"2015-04-21 00:00:00").getTime());
