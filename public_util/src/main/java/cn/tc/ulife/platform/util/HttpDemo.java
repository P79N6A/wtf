...
public class HttpDemo {
    ...
    static String account = "JSM41047";//
    //密码
    static String password = "ck2opmcv";//
    //校验码
    static String veryCode = "3c3zrefo4ewq";
...
//	static String SERVERIP = "http://202.102.89.226:8030";
    ...
    public static String sendTextSms(String mobile, String content) throws Exception {
        ...
        String address = HTTP_URL + "/service/httpService/httpInterface.do?method=sendGbkMsg";
...
//		params.append("&sendtime=").append("20151001113000"); //发送定时短信
    ...
    public static void main(String[] args) throws Exception {
        String result = "";
        //发送普通短信
        result = sendTextSms("15895879252,18061462502", "@1@=1234");
