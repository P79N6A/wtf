 ...
 *
 */
package cn.tc.ulife.platform.crm.msg;
...
public class AppResponseMsg extends ResponseMsg {
    ...
    public static AppResponseMsg success(Object data) {
        ...
        return new AppResponseMsg(ReturnMsg.SUCCESSS, "成功", data);
    }

    public static AppResponseMsg success() {

        return new AppResponseMsg(ReturnMsg.SUCCESSS, "成功", null);
    }
    ...
    public static AppResponseMsg faild(String msg) {
        return new AppResponseMsg(ReturnMsg.FALID, msg, null);
    }
    ...
    public static AppResponseMsg userFaild() {
        return new AppResponseMsg(ReturnMsg.USER_INVALID, "用户信息失效,请重新登录", null);
    }
}
