 ...
 *
 */
public class RKE_EquipmentBean {
	...
	/**
	 * @param eQ_AutoID
	 *            the eQ_AutoID to set
	 */
	public void setEQ_AutoID(String eQ_AutoID) {
		EQ_AutoID = eQ_AutoID;
	}
	...
	public String toString() {
		return "RKE_EquipmentBean [EQ_AutoID=" + EQ_AutoID + ", EQ_CommunityID=" + EQ_CommunityID + ", EQ_CS_ID="
				+ EQ_CS_ID + ", EQ_Name=" + EQ_Name + ", EQ_Num=" + EQ_Num + ", EQ_UserName=" + EQ_UserName
				...
				+ ", EQ_AddTime=" + EQ_AddTime + ", EQ_MAC=" + EQ_MAC + ", Creater=" + Creater + ", AccountSid="
				+ AccountSid + ", EQ_FaceIP=" + EQ_FaceIP + ", EQ_FacePwd=" + EQ_FacePwd + "]";
	}
