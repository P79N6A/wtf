...
//            logger.error("mapTobean,转换失败:", e);
    ...
    public static String getCronByMinute(Date date, int minMid) {
        ...
        String cron = null;
        try {
            Date str = SimpleThreadLocal.parse("2016-12-31 23:58:00", "yyyy-MM-dd HH:mm:ss");
            calendar.setTime(SimpleThreadLocal.parse(SimpleThreadLocal.format(str, "yyyy-MM-dd HH:mm:ss"),
                    "yyyy-MM-dd HH:mm:ss"));
