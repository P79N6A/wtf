...
/**
 * @author alliswell008
 * @ClassName: WareSpecificationPage
 * @Description: TODO(用一句话来说明)
 * @date 2017/2/23 14:49
 */
public class WareSpecPage {
    /**
     * 主键
     */
    private String id;
    ...
    public String[] getSptmS() {
        return sptmS;
    }

    public void setSptmS(String[] sptmS) {
        this.sptmS = sptmS;
    }
