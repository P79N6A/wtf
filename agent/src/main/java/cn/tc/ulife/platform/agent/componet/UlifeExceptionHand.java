...
import cn.tc.ulife.platform.agent.msg.ResponseMsg;
...
//            io.printStackTrace();
            logger.error("拦截:" + "请求url:" + httpServletRequest.getRequestURI() + "\t 返回信息:" + rmsg.toString() + "\t 请求ip" + httpServletRequest.getRemoteAddr() + "报错原因", io);
            logger.error("拦截:" + "请求url:" + httpServletRequest.getRequestURI() + "\t 返回信息:" + rmsg.toString() + "\t 请求ip" + httpServletRequest.getRemoteAddr() + "处理原因", e);
        }
        return mv;
    }
}
